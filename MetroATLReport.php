<?php
// Report by Jennifer Washington
// Metro Atlanta active listings
...
<head>
  <meta charset="utf-8">
  <title>Laker Realty - Metro Atlanta Listings</title>
...
<header>
  <div class="container nav">
    <div class="left">
      <img src="/logo.png" alt="Laker Realty logo">
...
<main class="container">
  <h1>Metro Atlanta Active Listings</h1>

  <div class="card">
    <p>Active properties in the Metro Atlanta region with type, city, state, and price.</p>
  </div>
  ...
  <div class="card">
    <?php if (!$rows): ?>
      <p>No active listings found for Metro Atlanta.</p>
    <?php else: ?>
      <table>
        <thead>
          <tr>
